...
const FeatureCard = ({
  ...
  return (
    <div className="bg-light-bg-card dark:bg-dark-bg-primary/80 border-2 border-light-accent-primary dark:border-dark-accent-primary rounded-xl p-6 hover:bg-light-bg-secondary dark:hover:bg-dark-bg-secondary/80 transition-colors shadow-sm w-full max-w-sm">
